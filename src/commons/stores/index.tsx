...
export const initialHitterStatsState = atom<IHitter[]>({
  key: "initialHitterStatsState", // 전역 상태의 고유 key
  default: [
    {
      player: "선수 1(팀A)",
      ab: 20,
...
export const initialPitcherStatsState = atom<IPitcher[]>({
  key: "initialPitcherStatsState", // 전역 상태의 고유 key
  default: [
